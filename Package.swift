...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/ducksee/libghostty-spm/releases/download/storage.1.0.1783936205/GhosttyKit.xcframework.zip",
            checksum: "d0c2b840107445ce5ab9e6a0a58bb05c5be5b942e8a025978537ee92ec84fd8f"
        ),
        .testTarget(
            name: "GhosttyKitTest",
