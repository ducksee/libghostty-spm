...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/ducksee/libghostty-spm/releases/download/storage.1.0.1788785138/GhosttyKit.xcframework.zip",
            checksum: "cf41dc8ba2fd738e1abebdb9bda89730419d3955ff16beb2901565a68abe6e29"
        ),
        .testTarget(
            name: "GhosttyKitTest",
