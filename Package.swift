...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/ducksee/libghostty-spm/releases/download/storage.1.0.1786349311/GhosttyKit.xcframework.zip",
            checksum: "408e9c7cef6fd59a242c6bfe4adb47c54b00c367df3df8bb0eaec84d205607d2"
        ),
        .testTarget(
            name: "GhosttyKitTest",
