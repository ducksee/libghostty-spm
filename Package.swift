...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/ducksee/libghostty-spm/releases/download/storage.1.0.1789390875/GhosttyKit.xcframework.zip",
            checksum: "97b926d1831aaf41756d8937e54f7146334da05158d67335d41ed6fd859bc9f5"
        ),
        .testTarget(
            name: "GhosttyKitTest",
