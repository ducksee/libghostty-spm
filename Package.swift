...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/ducksee/libghostty-spm/releases/download/storage.1.0.1787556733/GhosttyKit.xcframework.zip",
            checksum: "ee0215905c900a36d0b2dd96e2d2e37015d319bb1582d9eaddf815139de1e921"
        ),
        .testTarget(
            name: "GhosttyKitTest",
