...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/ducksee/libghostty-spm/releases/download/storage.1.0.1785147142/GhosttyKit.xcframework.zip",
            checksum: "68b34f8ce9121987362460d641878eb355bbab4d11542e0f6294e6313bdbc152"
        ),
        .testTarget(
            name: "GhosttyKitTest",
