...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/ducksee/libghostty-spm/releases/download/storage.1.0.1782732410/GhosttyKit.xcframework.zip",
            checksum: "5b6b5b1231858585459eab417606aa8f92d94b4851aa5dd30f9b6f00632ad599"
        ),
        .testTarget(
            name: "GhosttyKitTest",
