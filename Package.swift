...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/ducksee/libghostty-spm/releases/download/storage.1.0.1779101007/GhosttyKit.xcframework.zip",
            checksum: "08095ae8ba474a0f4dc9c7cdb293a0cff68cf762482e657ac09bdf09dcd8dc52"
        ),
        .testTarget(
            name: "GhosttyKitTest",
