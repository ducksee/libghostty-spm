...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/ducksee/libghostty-spm/releases/download/storage.1.0.1780917747/GhosttyKit.xcframework.zip",
            checksum: "de38095aeee4758af1b317e730df6e94aa455b04c0c7a9a1aa38faab93617965"
        ),
        .testTarget(
            name: "GhosttyKitTest",
