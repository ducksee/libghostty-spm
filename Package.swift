...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/ducksee/libghostty-spm/releases/download/storage.1.0.1781527524/GhosttyKit.xcframework.zip",
            checksum: "b711cce2550a7dc1aa241c0a259907e521caae36256d878b9ae86c5d6c0721c2"
        ),
        .testTarget(
            name: "GhosttyKitTest",
