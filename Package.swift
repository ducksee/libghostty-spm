...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/ducksee/libghostty-spm/releases/download/storage.1.0.1778493760/GhosttyKit.xcframework.zip",
            checksum: "5e79552d62df77109d883621e892107d2b6f93f24b929223b489d8245de5e647"
        ),
        .testTarget(
            name: "GhosttyKitTest",
