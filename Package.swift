...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/ducksee/libghostty-spm/releases/download/storage.1.0.1784540301/GhosttyKit.xcframework.zip",
            checksum: "403662254624fe3cd5c9dbc18730d01e84c0c648f9e76094f49c12c13448fab7"
        ),
        .testTarget(
            name: "GhosttyKitTest",
