...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/ducksee/libghostty-spm/releases/download/storage.1.0.1783336093/GhosttyKit.xcframework.zip",
            checksum: "9fbfaf64f38c432bc7c5160cd7a7243b852069867b92a3f1ad275ffca808f197"
        ),
        .testTarget(
            name: "GhosttyKitTest",
