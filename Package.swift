...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/ducksee/libghostty-spm/releases/download/storage.1.0.1782131324/GhosttyKit.xcframework.zip",
            checksum: "735391d1ee67f1f2d2cbbfc9cfc147af73a42d1e97e8d62f4054fed5c861c42d"
        ),
        .testTarget(
            name: "GhosttyKitTest",
