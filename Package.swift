...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/ducksee/libghostty-spm/releases/download/storage.1.0.1788185127/GhosttyKit.xcframework.zip",
            checksum: "71dc40304ace18980736187d58c909269b0f8a47616445631c0aef941f559e8a"
        ),
        .testTarget(
            name: "GhosttyKitTest",
