...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/ducksee/libghostty-spm/releases/download/storage.1.0.1779706351/GhosttyKit.xcframework.zip",
            checksum: "794935388f3f23d42f0c65a2edd3a065222ce9776697ad34e40acd9b98af988e"
        ),
        .testTarget(
            name: "GhosttyKitTest",
