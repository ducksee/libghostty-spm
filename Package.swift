...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/ducksee/libghostty-spm/releases/download/storage.1.0.1789995613/GhosttyKit.xcframework.zip",
            checksum: "2275b29df4133892102aa3196deb9045198760536862912de792924afb67e9dc"
        ),
        .testTarget(
            name: "GhosttyKitTest",
